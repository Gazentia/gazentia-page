...
const techs = [
  ...
  },
  {
    id: "t13",
    name: "Vue.js",
    info: "An open-source JavaScript library that is used for building user interfaces specifically for single-page applications.",
    status: 1,
  },
  {
    id: "t14",
    name: "Nuxt.js",
    info: "A open-source JavaScript library based on Vue.js, Node.js, Webpack and Babel.js. Nuxt is inspired by Next.js,[4] which is a framework of similar purpose, based on React.js.",
    status: 2,
  },
];
...
function updateCopyrightDate() {
  ...
  const copyrightElem = document.querySelector("#copyrightDate");
  copyrightElem.innerText = fullYear;
}
